<%@ Control Language="vb" AutoEventWireup="true" CodeBehind="Settings.ascx.vb" Inherits="kulturkatalogenadmin.aj.kk_aj_utovareArrListkk_aj_utovareArrList.Settings" %>
